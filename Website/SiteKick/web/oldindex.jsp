                                ...
                                <div class="text">
                                    ...
                                    <form action="ProcessServlet">
                                        <div class="form-group">
                                            <input type="url" class="form-control" name="txtDomain" placeholder="http://www.yourdomain.com"/>  
                                        </div>
                                        <a class="boxed-btn3" href="#"><input type="submit" name="action" value="Analyze" id="btn-submit"></a>
                                    </form>
                                </div>
