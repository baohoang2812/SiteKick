...
import sitekick.data.TechStacks;
...
public class SiteService {
    ...
    public String getAllSitesXMLString() throws JAXBException, XMLStreamException {
        ...
        List<sitekick.entity.Site> siteList = siteDAO.getAllSite();
        ...
        List<TechStack> techStackList = siteList.stream().map(s -> {
            ...
            List<sitekick.entity.Technology> techEntityList = new ArrayList(s.getTechnologyCollection());
